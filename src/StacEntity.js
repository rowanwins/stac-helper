...
/**
 * This is the parent class for Catalog, Collection or Item Classes.
 * It contains functionality that is common across all.
 * @class
 */
export class StacEntity {
     ...
     * @param {json} json REQUIRED: The raw json of the stac entity
    ...
    /**
     * Gets a string of either the title, or if not present null
    ...
    */
    get linkToParent () {
        if (this.hasParent && this.rawJson.links.findIndex(i => i.rel === 'parent') > -1) {
            const parent = this.rawJson.links.find(i => i.rel === 'parent')
            const parentUrl = parent.href
            if (isRelativeUrl(parentUrl)) {
                return resolveRelative(parentUrl, this.url)
            }
            return parentUrl
    ...
    */
    ...
    /**
    * The url of the asset that has a thumbnail role. Returns null if doesn't not exist
    * @return {string|null}
    */
    get thumbnailUrl () {
    ...
    /**
    * The url of the asset that has a overview role. Returns null if doesn't not exist
    * @return {string|null}
    */
    get overviewUrl () {
        if (this.numberOfAssets === 0) return null
    ...
    */
    ...
    /**
     * Returns an object containing licenseName and link. If license is not available then null.
     * @return {Object | null} An object containing a licenseType string, and a link string. Or null if a parent is not present.
     */
    ...
    */
    ...
    async loadRoot () {
        ...
        // This Stac Entity is the Root
        if (this.linkToRoot === this.url) return this

        if (this.parentIsRoot && this.parent) return this.parent
        if (this.linkToRoot === this.parent.linkToSelf) return this.parent
