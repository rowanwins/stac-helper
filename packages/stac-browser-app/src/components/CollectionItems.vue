  ...
  <div v-if="items">
      ...
      <ACol :span="24">
        <div style="float:right;">
          ...
          <AButton
            ...
            :disabled="pageIndex === 1 || loadingItems"
            @click="$emit('get-prev-page')"
          >
            <left-outlined />
            Prev Page
          </AButton>
    ...
    <div v-if="items.length > 0 && !loadingItems">
      <ListItems
        ...
        @remove-highlight="removeHighlightItem"/>
    </div>
...
export default {
  ...
  props: ['items', 'pageIndex', 'loadingItems', 'leafletMap', 'applyingFilter'],
  components: {
    LeftOutlined,
    RightOutlined,
    ItemsFilter,
